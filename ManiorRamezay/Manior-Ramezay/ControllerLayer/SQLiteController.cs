...
{  
    ...
    internal class SQLiteController
    {
        ...
        internal SQLiteController()
        {
            ...
            cmdCreateTable.CommandText = "DROP TABLE ROOM;";
            cmdCreateTable.ExecuteNonQuery();
            ...
            cmdCreateTable.CommandText = "CREATE TABLE IF NOT EXISTS Reservation(RESERVATIONID varchar, PAYMENT varchar, DOWNPAYMENT varchar,RSTATUS varchar );";
            cmdCreateTable.ExecuteNonQuery();

            cmdCreateTable.CommandText = "CREATE TABLE IF NOT EXISTS Clock(TIME varchar, COUNTROOM varchar, COUNTCUSTOMER varchar,COUNTBOOKING varchar,COUNTRESERVE varchar );"; 
            cmdCreateTable.ExecuteNonQuery();
